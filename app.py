...
Объясни коротко. Если ответ верный — 1-2 предложения. Если ошибка — 2-4 предложения, укажи правильный способ решения.
Пиши на русском. Используй **жирный** для терминов.'''
